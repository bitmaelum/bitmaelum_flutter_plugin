...
import 'package:bitmaelum_flutter_plugin/bridge/ffi.dart';
import 'package:bitmaelum_flutter_plugin/bridge/isolate.dart';
import 'package:bitmaelum_flutter_plugin/bitmaelum_flutter_plugin.dart';

class Binding {
  static final String _callFuncName = 'BitMaelumClientBridgeCall';
  static final String _libraryName = 'libbitmaelum_bridge';
  ...
  void handleError(
    ...
    if (error.address != ffi.nullptr.address) {
      ...
      freeResult(result);
      throw new BitmaelumException(message);
    }
  }
